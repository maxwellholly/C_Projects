...
for (i = 0; i < data.results.forecast.length; i++){
    ...
    console.log("Today is " + data.results.forecast[i].day + ". The high is " + data.results.forecast[i].high + ". The low is " + data.results.forecast[i].low + ". It will be " + data.results.forecast[i].text.toLowerCase() + ".");
...
for (i = 0; i < myJSON.people.length; i++){

    console.log("Employee: " + obj.employees[i].firstName + " " + obj.employees[i].lastName + " Occupation: " + myJSON.people[i].job);
